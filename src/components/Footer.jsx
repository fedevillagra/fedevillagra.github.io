        ...
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 border-t border-gray-100 pt-8">
            <p className="text-center text-xs leading-relaxed text-gray-500">
              ...
              <br/>Created with <a href="" className="text-gray-700 underline transition hover:text-gray-700/75">
                Laravel
                </a> and <a href="" className="text-gray-700 underline transition hover:text-gray-700/75">
                Laravel Livewire
                </a>.
            </p>
          </div>
